...
def main(page: ft.Page):
    ...
    N_df = N_culculate(1, 50, H_list, Mu_list)         #<<<<<main calculation
    ...
    def N_culc(e):
        ...
        N_df = N_culculate(int(I.value), int(L.value), H_list, Mu_list) #>>>>main calculation
